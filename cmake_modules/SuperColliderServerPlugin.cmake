...
function(sc_add_server_plugin dest_dir name cpp sc schelp sctests)
    ...
    if(SCSYNTH)
        ...
        install(TARGETS ${sy_name} LIBRARY DESTINATION ${dest_dir}/${subdir})
