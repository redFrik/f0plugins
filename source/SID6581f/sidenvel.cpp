...
/*INLINE*/ void enveEmuEnveAdvance(sidOperator* pVoice)		//f0 -removed inline
{
#ifdef SID_FPUENVE
...
/*INLINE*/ uint16 enveEmuMute(sidOperator* pVoice)			//f0 -removed inline
{
	return 0;
}
...
/*INLINE*/ uint16 enveEmuRelease(sidOperator* pVoice)					//f0 -removed inline
{
#ifdef SID_FPUENVE
...
/*INLINE*/ uint16 enveEmuAlterRelease(sidOperator* pVoice)			//f0 -removed inline
{
...
/*INLINE*/ uint16 enveEmuStartRelease(sidOperator* pVoice)			//f0 -removed inline
{
...
/*INLINE*/ uint16 enveEmuSustain(sidOperator* pVoice)				//f0 -removed inline
{
	return masterAmplModTable[pVoice->sid->masterVolumeAmplIndex+pVoice->enveVol];
}

/*INLINE*/ uint16 enveEmuSustainDecay(sidOperator* pVoice)			//f0 -removed inline
{
#ifdef SID_FPUENVE
	pVoice->enveStep = (uint16)pVoice->fenveStep;
#endif
...
/*INLINE*/ uint16 enveEmuAlterSustainDecay(sidOperator* pVoice)		//f0 -removed inline
{
...
/*INLINE*/ uint16 enveEmuAlterSustain(sidOperator* pVoice)			//f0 -removed inline
{
	if ( pVoice->enveVol > pVoice->enveSusVol )
	{
...
/*INLINE*/ uint16 enveEmuDecay(sidOperator* pVoice)				//f0 -removed inline
{
#ifdef SID_FPUENVE
	pVoice->enveStep = (uint16)pVoice->fenveStep;
#endif
...
/*INLINE*/ uint16 enveEmuAlterDecay(sidOperator* pVoice)		//f0 -removed inline
{
	uint8 decay = pVoice->SIDAD & 0x0F ;
#ifdef SID_FPUENVE
	pVoice->fenveStepAdd = decayReleaseRates[decay];
...
/*INLINE*/ uint16 enveEmuStartDecay(sidOperator* pVoice)		//f0 -removed inline
{
...
/*INLINE*/ uint16 enveEmuAttack(sidOperator* pVoice)			//f0 -removed inline
{
#ifdef SID_FPUENVE
	pVoice->enveStep = (uint16)pVoice->fenveStep;
#endif
...
/*INLINE*/ uint16 enveEmuAlterAttack(sidOperator* pVoice)			//f0 -removed inline
{
...
/*INLINE*/ uint16 enveEmuStartAttack(sidOperator* pVoice)			//f0 -removed inline
{
...
/*INLINE*/ uint16 enveEmuShortAttack(sidOperator* pVoice)		//f0 -removed inline
{
#ifdef SID_FPUENVE
	pVoice->enveStep = (uint16)pVoice->fenveStep;
#endif
...
/*INLINE*/ uint16 enveEmuAlterShortAttack(sidOperator* pVoice)		//f0 -removed inline
{
	uint8 attack = pVoice->SIDAD >> 4;
#ifdef SID_FPUENVE
	pVoice->fenveStepAdd = attackRates[attack];
...
/*INLINE*/ uint16 enveEmuStartShortAttack(sidOperator* pVoice)		//f0 -removed inline
{
