...
//static int8* ampMod1x8;									//f0 -changed this
int8 ampMod1x8[256*256];
...
void sidInitMixerEngine(void)
{
	...
	//ampMod1x8=(int8*) auto_malloc(256*256);				//f0 -commented out and moved to top
...
/*INLINE*/ void waveAdvance(sidOperator* pVoice)			//f0 -removed inline
{
...
/*INLINE*/ void noiseAdvance(sidOperator* pVoice)			//f0 -removed inline
{
...
/*INLINE*/ void noiseAdvanceHp(sidOperator* pVoice)			//f0 -removed inline
{
...
/*INLINE*/ void waveCalcCycleLen(sidOperator* pVoice)			//f0 -removed inline
{
#if defined(DIRECT_FIXPOINT)
...
/*INLINE*/ void waveCalcFilter(sidOperator* pVoice)			//f0 -removed inline
{
